    ...
    <div class="row">
      ...
      <%
        ...
        try{
          ...
          sql = "select book.bookid,bookname,price,number,picpath from book,cart where book.bookid = cart.bookid AND uid= ? ";
      ...
      <div class="col-sm-4 col-md-3">
        <div class="thumbnail" >
          ...
          <div class="caption center">
            ...
            <%--</p><p class="line-center">--%><br>
              <span>价格:</span><span><%=rs.getString("price")%></span>
            <%--</p><p class="line-center">--%><br>
            ...
            <%--</p><p class="line-center">--%><br>
              <div class="col-sm-2 line-center">总价：<%=totalprice%></div>
            <%--</p><p class="line-center">--%><br>
              <%--<div class="col-sm-1 line-center">--%>
              <div class="col-sm-1 line-center">
                <button class="btn btn-danger" onclick="javascript:location.href='cart.jsp?action=down&bookid=<%=rs.getString(1)%>&number=-1'">删除</button>
              </div>
            </p>
          </div>
        </div>
      ...
      <%--<div class="col-sm-12  list-group-item">--%>
        <%--&lt;%&ndash;<div class="col-sm-1 line-center" style="width: 50px;height: 50px;">&ndash;%&gt;--%>
          <%--&lt;%&ndash;<img src="img/icons/png/Book.png" style="height: 100%;" alt=""/>&ndash;%&gt;--%>
        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
