...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
  <div class="container">
    <div class="navbar-header">
      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navi_top">

      </button>
      <a class="navbar-brand" href="index.jsp">图书商城</a>
    </div>
    <div class="navbar-collapse collapse" id="navi_top">
...
<div class="container" style="margin-top: 7rem">
  <div class="row thumbnail center col-sm-12">
      ...
      <nav class="navbar navbar-inverse  navbar-expand-lg" role="navigation">
        ...
        <div class="navbar-collapse collapse" id="navbar-collapse-01">
          ...
          <ul class="nav navbar-nav mr-auto">
            <li id="nav_userHome"><a href="#">个人中心</a></li>
            <li id="nav_editInfo"><a href="#">信息修改</a></li>
            <li id="nav_editPassword"><a href="#">密码修改</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
      </nav><!-- /navbar -->
    </div>
    ...
    <%--<ul class="nav nav-tabs nav-justified" id="myTabs">--%>
      <%--<li class="active" id="nav_userHome"><a href="#" >个人中心</a></li>--%>
      <%--<li><a href="#" id="nav_editInfo">信息修改</a></li>--%>
      <%--<li><a href="#" id="nav_editPassword">密码修改</a></li>--%>
    <%--</ul>--%>
    <!-- Tab panes -->
    <div class="tab-content">

      <%--<div role="tabpanel" class="tab-pane active" id="userHome">--%>
      <div role="tabpanel" id="userHome">
        <br>
        <%
          // 个人中心 输出个人信息
      ...
      %>
      <div role="tabpanel" id="editPassword">
...
<script>
    $(document).ready(function(){
        ...
        $("#nav_userHome").addClass("active");

        $("#nav_userHome").click(function(){
            $("#nav_userHome").addClass("active");
            $("#nav_editInfo").removeClass("active");
            $("#nav_editPassword").removeClass("active");
            $("#userHome").css('display','block');
            $("#editInfo").css('display','none');
            $("#editPassword").css('display','none');
        });
        $("#nav_editInfo").click(function(){
            $("#nav_userHome").removeClass("active");
            $("#nav_editInfo").addClass("active");
            $("#nav_editPassword").removeClass("active");
            $("#userHome").css('display','none');
            $("#editInfo").css('display','block');
            $("#editPassword").css('display','none');
        });
        $("#nav_editPassword").click(function(){
            $("#nav_userHome").removeClass("active");
            $("#nav_editInfo").removeClass("active");
            $("#nav_editPassword").addClass("active");
            $("#userHome").css('display','none');
            $("#editInfo").css('display','none');
