        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            ...
            <%--<label class="radio-inline">--%>
              ...
              <input type="radio" name="sex" id="inlineRadio1" value="0" data-toggle="radio">
              男
            </label>
            <label class="radio">
            <%--<label class="radio-inline">--%>
              <%--<input type="radio" name="sex" id="inlineRadio2" value="1" required>女--%>
              <input type="radio" name="sex" id="inlineRadio2" value="1" data-toggle="radio" checked>
              女
            </label>
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input type="tel" class="form-control" id="telephone" name="telephone"
                   ...
                   data-error="请输入正确的电话号码" required>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" id="address" name="address"
                   placeholder="地址" data-error="请输入正确的地址" required>
          </div>
        </div>
        <div class="form-group">
